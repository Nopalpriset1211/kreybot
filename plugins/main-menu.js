...
let menulist = async (m, { conn, usedPrefix, command, args }) => {
  ...
  if (perintah === 'tags') {
    ...
    let list = `Hallo @${m.sender.split("@")[0]} 👋️ *saya HannXD*
...
`
 const pp = await conn.profilePictureUrl(m.sender, 'image').catch((_) => "https://telegra.ph/file/2c69ad2b8a9bddbb21e3a.jpg");
 {
 	var menump3 =
 fs.readFileSync('./lagu.mp3')
 await conn.sendMassege(m.chat,{audio:menump3,
 mimetype:'audio/mpeg',ptt:true},{quoted:m}) }
